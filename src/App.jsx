      ...
      <div className="cv">
        <header className="header">
          <div>
            ...
            <p className="target">
              Recherche une alternance pour 2026 – Data Analyst
            </p>
          </div>
        ...
        <section className="section">
          <h3>Profil</h3>
          <p>
            Développeuse web en reconversion, je me spécialise en analyse de données.
            Grâce à mon expérience en développement fullstack, je connais la manipulation et la structuration de données (MongoDB, JavaScript) ainsi que les requêtes SQL.
            Je développe actuellement mes compétences en Python et en data visualisation (Power BI).
            Je recherche une alternance en Data Analyst pour approfondir mes compétences en analyse et exploitation des données.
          </p>
        </section>
